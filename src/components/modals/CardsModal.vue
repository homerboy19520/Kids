<template>
  <div class="cards-modal" :class="{center:!isShow}">
    <Paragraph v-if="isShow" size=16 tag="p" weight="medium" color="black">Дети (макс. 5)</Paragraph>
    <Button v-if="isAdd" @click="onButton" modifier="secondary">
